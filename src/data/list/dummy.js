export const projectList = [
    ...
    },
    {
        ...
        period: "2022.02.07 ~ 2022.03.01",
        intro: "UI 부터 배포까지 웹사이트의 전체적인 흐름을 파악할 수 있었던 프로젝트",
    ...
    },
    {
        ...
        intro: "기존의 버거킹 프로젝트에 MVC패턴을 적용하여 이용자별(사용자, 관리자) 로직처리를 적용한 웹 사이트",
        skill: ["html", "jsp", "css", "javascript", "java", "oracle xe 11gr2"],
        responsibilities: [
            "사용자 이벤트 페이지 조회 구현",
